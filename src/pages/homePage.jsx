        ...
        <div className="container relative z-10 px-4 mx-auto text-center">
          <div className="max-w-3xl p-10 mx-auto bg-black border border-white backdrop-blur-sm bg-opacity-30 rounded-2xl border-opacity-20">
            <h2 className="mb-6 text-5xl font-bold text-white">
              Explore Our <span className="text-yellow-400">Exclusive</span>{' '}
              Collection
            </h2>
        ...
        <div className="container px-4 mx-auto text-center">
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <button
                type="submit"
                className="px-8 py-3 font-semibold text-black transition-all duration-300 bg-yellow-400 rounded-full hover:bg-yellow-500"
              >
                Subscribe
              </button>
            </form>
